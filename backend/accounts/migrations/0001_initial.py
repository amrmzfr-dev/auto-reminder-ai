# Generated by Django 5.2.3 on 2025-08-05 07:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pic_email', models.EmailField(blank=True, max_length=254, null=True, verbose_name='PIC Email')),
                ('company_ssm_number', models.CharField(blank=True, max_length=50, null=True, verbose_name='Company Registration Number (SSM)')),
                ('operational_state', models.CharField(blank=True, choices=[('Central 1', 'Wdsadsadilayah Persekutuan KL, Putrajaya'), ('Central 2', 'Selangor'), ('Northern', 'Perak, Kedah, Perlis, Penang'), ('Southern', 'N.Sembilan, Melaka, Johor'), ('East Coast', 'Pahang, Terengganu, Kelantan'), ('East Malaysia', 'Sabah, Sarawak')], max_length=50, null=True)),
                ('pic_designation', models.CharField(blank=True, max_length=100, null=True, verbose_name='PIC Designation')),
                ('company_address', models.TextField(blank=True, null=True, verbose_name='Business Address')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='installerprofile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
